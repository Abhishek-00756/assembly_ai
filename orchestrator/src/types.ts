...
export type OrchestratorToClientEvent={type:"audio_out";audio:string}|{type:"transcript_partial"|"transcript_final";text:string;speaker:"user"|"agent"}|{type:"phase_update";phase:Phase}|{type:"completeness_update";completeness:import("@insuranos/schema").CompletenessResult}|{type:"photo_requested";photo_type:string}|{type:"session_paused"}|{type:"session_resumed"}|{type:"report_ready";report_url:string|null;summary_text:string}|{type:"error";message:string};
